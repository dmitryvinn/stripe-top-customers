...
import com.stripe.customers.list.config.audit.AuditEventConverter;
import com.stripe.customers.list.domain.PersistentAuditEvent;
...
import static com.stripe.customers.list.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
